...
-- Generate varied reservations for screen capture data.
-- Each carwash has a different monthly volume (84-112 reservations).
-- A user is assigned at most once per day; slots are 1 or 2 hours long.
